                            ...
                            >
                              {cells.map((cell, cellIndex) => {
                                const sharedClassName =
                                  "border-b border-r border-slate-200 p-4 text-left whitespace-pre-wrap leading-6 last:border-r-0";
                              ...
                              {isHeaderRow ? (
                                <th className="border-b border-slate-200 bg-slate-900 p-4 text-left text-sm font-semibold text-white">
                                  操作
                                </th>
                              ) : (
                                <td className="border-b border-slate-200 bg-white p-4 align-top">
                                  <button
                                    type="button"
