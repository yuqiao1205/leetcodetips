...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(59,130,246,0.14),_transparent_38%),linear-gradient(180deg,_#f8fafc_0%,_#eef2ff_100%)] px-3 py-5 text-slate-900 sm:px-6 sm:py-8 lg:px-8">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8">
        <section className="overflow-hidden rounded-[1.75rem] border border-white/60 bg-white/85 p-5 shadow-[0_24px_80px_rgba(15,23,42,0.12)] backdrop-blur sm:rounded-[2rem] sm:p-8 xl:p-10">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl space-y-4">
              ...
              <p className="text-sm leading-7 text-slate-600 sm:text-base lg:text-lg">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 sm:gap-4 lg:min-w-[340px]">
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 sm:col-span-1">
